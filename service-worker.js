...
const ASSETS = ['./', './index.html', './assets/styles.css?v=12.3.1', './assets/app.js?v=12.3.1', './assets/icon.svg', './assets/icon-maskable.svg', './manifest.webmanifest', './data/sample-weeks.json'];
