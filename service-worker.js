...
const ASSETS = ['./', './index.html', './assets/styles.css?v=12.5.3', './assets/app.js?v=12.5.3', './assets/icon.svg', './assets/icon-maskable.svg', './manifest.webmanifest', './data/sample-weeks.json'];
