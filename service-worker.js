...
const ASSETS = ['./', './index.html', './assets/styles.css?v=12.5.7', './assets/app.js?v=12.5.7', './assets/icon.svg', './assets/icon-maskable.svg', './manifest.webmanifest', './data/sample-weeks.json'];
